...
export default function Skills(props) {
  ...
  return (
    <div>
      <h1 className="skills-title" style={style.darkModeText}>SKILLS</h1>
      <div className="skills-list">
        <div className="skills-list-item">
          <h4 className="skill-list-name langauge" style={style.darkModeText}>language</h4>
          {/* Java */}
          <img src={JAVA} alt="JAVA" className="skill-icon"/>
        </div>
        <div className="skills-list-item">
          <h4 className="skill-list-name frontend" style={style.darkModeText}>frontend</h4>
        ...
        <div className="skills-list-item">
          <h4 className="skill-list-name backend" style={style.darkModeText}>backend</h4>
          <img src={props.darkMode ? Node_Dark : Node_Light} alt="NODE" className="skill-icon"/>
          <img src={Mongodb} alt="MONGODB" className="skill-icon"/>
          <img src={props.darkMode ? Mongoose_Dark : Mongoose_Light} alt="MONGOOSE" className="skill-icon"/>
        </div>
        <div className="skills-list-item">
          <h4 className="skill-list-name langauge" style={style.darkModeText}>tools</h4>
          <img src={GIT} alt="GIT" className="skill-icon"/>
          <img src={props.darkMode ? GITHUB_DARK : GITHUB_LIGHT} alt="GITHUB" className="skill-icon"/>
